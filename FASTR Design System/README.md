...
- **Workshop slide icons (SVG)** — `lecture.svg`, `communication.svg`, `thought.svg`, `pinned-notes.svg`, `raise-hand.svg`, `hands_on.svg`, `demo.svg`, `hospital_clinic.svg`, `people_group.svg` — Lucide-style line icons, 24×24 viewBox, FASTR-green stroke. Drop into Marp at ~120 px tall.
