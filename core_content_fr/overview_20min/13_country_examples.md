...
**Nigeria :** Permettre un suivi continu et actualisé des indicateurs présidentiels hautement prioritaires dans le cadre de l'Initiative nationale de réforme du secteur de la santé aux niveaux fédéral et des États. Les résultats alimentent les dialogues trimestriels sur la performance et les plans opérationnels annuels des États qui régissent la mise en œuvre du secteur de la santé.

**Guinée :** Renforcement des compétences tout au long du cycle d'utilisation des données de l'analyse à l'action avec DHIS2, de l'amélioration des capacités d'extraction de données à l'amélioration des processus d'interprétation et d'utilisation des données sur une base trimestrielle.
...
<!--
PRESENTER NOTES:
- Ces exemples montrent la flexibilité de FASTR au-delà de l'analyse des perturbations
- Thèmes communs : institutionnalisation de l'utilisation des données, alimentation des processus de revue existants, renforcement des capacités
- Chaque pays adapte FASTR à ses priorités politiques et structures de gouvernance spécifiques
-->
