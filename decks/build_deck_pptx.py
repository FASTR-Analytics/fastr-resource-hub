...
GOV_EN = [
    ...
    {"type": "image", "title": "How the data is protected",
     "lead": "The platform checks who you are at every step, makes everything unreadable while it travels, and keeps automatic backup copies.",
...
GOV_FR = [
    ...
    {"type": "image", "title": "Comment les données sont protégées",
     "lead": "La plateforme vérifie qui vous êtes à chaque étape, rend tout illisible pendant le transport et garde des copies de sécurité automatiques.",
