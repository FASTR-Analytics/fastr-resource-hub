...
GOV_EN = [
    ...
    {"type": "content", "title": "The figures — planning estimates", "blocks": [
        ...
        {"t": "No further subscriptions: the **AI line is the Anthropic API cost**, and the **login service (Clerk) is covered within shared maintenance**", "bullet": True},
        {"t": "**Economies of scale apply**: one team and one codebase serve every country — the maintenance share falls as countries join, and is forgone under self-hosting", "bullet": True},
    ]},
...
GOV_FR = [
    ...
    {"type": "content", "title": "Les chiffres — estimations de planification", "blocks": [
        ...
        {"t": "Aucun autre abonnement : la **ligne IA correspond au coût de l'API Anthropic**, le **service de connexion (Clerk) est couvert par la maintenance partagée**", "bullet": True},
        {"t": "**Les économies d'échelle s'appliquent** : une équipe et un code servent tous les pays — la part de maintenance baisse à mesure que des pays rejoignent, et disparaît en auto-hébergement", "bullet": True},
    ]},
