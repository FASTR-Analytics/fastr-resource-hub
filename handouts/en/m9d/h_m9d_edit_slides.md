...
![Slide editor with a content slide open h:280](../../../resources/screenshots/m9d/edit_slides_01_editor_layout.png)
...
<h2 class="step-h"><span class="step-n">1</span><span>Add ▸ — divide the slide into columns or rows</span></h2>
...
![Add submenu showing Col to left / Col to right / Row above / Row below h:340](../../../resources/screenshots/m9d/edit_slides_06_add_submenu.png)
...
<h2 class="step-h"><span class="step-n">2</span><span>Move ▸ — reposition a cell without dragging</span></h2>

Right-click → **Move** → choose **Left**, **Right**, **Up**, or **Down**. Only directions that make sense for the current layout are shown.

![Move submenu with Left option h:340](../../../resources/screenshots/m9d/edit_slides_05_move_submenu.png)
...
<h2 class="step-h"><span class="step-n">1</span><span>Check accuracy</span></h2>
...
<h2 class="step-h"><span class="step-n">2</span><span>Resize and reflow</span></h2>
...
<h2 class="step-h"><span class="step-n">3</span><span>Restructure if needed</span></h2>
