...
2. Dans la barre d'actions qui apparaît, cliquez sur **Importer les données HMIS depuis DHIS2**. L'assistant d'importation s'ouvre, déjà réglé sur ces indicateurs.
   ...
   ![w:240](../../../resources/screenshots/indicateurs_v2/06_actions_groupees.png)
3. **Heure** : choisissez **Maintenant** pour lancer l'importation tout de suite, puis **Suivant**.

   ![h:95](../../../resources/screenshots/dhis2_import_v2/06_wizard_heure.png)
...
4. **Modules** : cochez les modules à exécuter. Si un module en nécessite un autre, FASTR l'ajoute tout seul. Puis **Suivant**.

   ![w:380](../../../resources/screenshots/indicateurs_v2/08_paquet_modules.png)
