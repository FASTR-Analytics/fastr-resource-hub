...
<div class="setup-breadcrumb"><span class="step current">Connexion</span> <span class="arrow">→</span> <span class="step">Votre dossier</span></div>
...
Vous devriez atterrir sur un écran de connexion.
...
- **L'e-mail de vérification n'arrive jamais** — vérifiez le spam. Si toujours rien après 5 min, demandez à votre facilitateur de le redéclencher.
