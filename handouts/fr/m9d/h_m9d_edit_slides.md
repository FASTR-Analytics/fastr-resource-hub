...
<div class="setup-breadcrumb"><span class="step done">Créer la présentation</span> <span class="arrow">→</span> <span class="step done">Ajouter manuellement</span> <span class="arrow">→</span> <span class="step done">Ajouter avec l'IA</span> <span class="arrow">→</span> <span class="step current">Éditer et finaliser</span></div>
