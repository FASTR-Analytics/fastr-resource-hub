...
<div class="setup-breadcrumb"><span class="step current">Construire un prompt clair</span> <span class="arrow">→</span> <span class="step">Explorer</span> <span class="arrow">→</span> <span class="step">Itératif vs unique</span> <span class="arrow">→</span> <span class="step">Affiner</span> <span class="arrow">→</span> <span class="step">Modèle PDF</span> <span class="arrow">→</span> <span class="step">Vérifier la sortie</span></div>
...
Passez à **Explorer avec l'Assistant IA** pour tester ce prompt sur la plateforme et voir comment de petits changements dans un prompt modifient la sortie.
