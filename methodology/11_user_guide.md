...
!!! info "Looking for platform concepts?"
    For an overview of the platform's capabilities, architecture, and key concepts, see [FASTR analytics platform](03_fastr_analytics_platform.md).
