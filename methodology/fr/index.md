<!-- AUTO-TRANSLATED from index.md -->
<!-- Add REVIEWED marker after human review to protect from overwrite -->

<div style="text-align : center ; margin-bottom : 2em ;" markdown>

![Logo FASTR](resources/logos/FASTR_Primary_01_FullName.png){ : style="max-width : 600px ; width : 100%"}

</div>

# FASTR SRMNIA-N service use monitoring
...
| Section | Description |
|---------|-------------|
| [**Introduction**](00_introduction.md) | Vue d'ensemble de FASTR, de l'analyse en cycle rapide et de l'approche de l'analyse des données de routine | [**Identifier les questions et les indicateurs**](01_identify_questions_indicateurs.md)
| [**Identifier les questions et les indicateurs**](01_identify_questions_indicateurs.md) | Définir les questions prioritaires et sélectionner les indicateurs de base | [**Indentifier les questions et les indicateurs**](01_identify_questions_indicateurs.md)
| L'extraction des données**](02_data_extraction.md) | Extraire et préparer les données SIGS pour l'analyse |
| La plateforme d'analyse de données FASTR**](03_FASTR_analytics_plateforme.md) | Utilisation de la plateforme pour l'analyse automatisée
| module 1 de la plate-forme. Évaluation de l'exhaustivité et de la cohérence
...
| Estimation de la couverture**](06b_couverture_estimates.md) | module 4 de la plateforme. Estimation de la couverture des services par rapport aux objectifs
