...
Utiliser ask_user_questions pour poser chacune des questions suivantes une à la fois :
1. « Sur quelle zone infranationale ce rapport doit-il se concentrer ? » — proposer les zones disponibles comme options sélectionnables (l'utilisateur peut aussi saisir la sienne). Inclure les zones de tous les niveaux administratifs disponibles dans la plateforme
