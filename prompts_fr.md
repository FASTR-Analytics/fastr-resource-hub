...
- Titre : « Suivi des perturbations des services essentiels à partir des données du SNIS à/au/en [NOM DE LA ZONE], [PAYS] »
  - Adapter l'article selon le pays et la zone (au Sénégal, à Madagascar, en Côte d'Ivoire, au Tchad, etc.)
- Sous-titre : « [SOUS_TITRE_RAPPORT] »
- Ajouter un bloc de texte en bas : « Analyse générée en [MOIS_ANNÉE_ACTUEL] »
...
Analyse des perturbations et des surplus dans l'utilisation des services, qui détecte les changements significatifs (positifs ou négatifs) dans l'utilisation des services au-delà de ce qui serait attendu compte tenu de la saisonnalité et des tendances historiques. Les résultats sont présentés pour [NOM DE LA ZONE].
