...
MODULES = {
    0: {
        ...
        'topics': [
            ('m0_0', 'm0_0_what_are_we_trying_to_achieve.md'),
            ('m0_1', 'm0_1_how_can_this_be_achieved.md'),
            ('m0_2', 'm0_2_what_is_fastr.md'),
            ('m0_3', 'm0_3_fastr_approach_rmncahn.md'),
        ],
    },
    1: {
        ...
        'topics': [
            ...
            ('m1_2a', 'm1_2a_country_indicator_selection.md'),
            ('m1_3', 'm1_3_high_volume_indicators.md'),
            ('m1_3a', 'm1_3a_high_completeness_indicators.md'),
            ('m1_3b', 'm1_3b_count_indicators.md'),
        ],
    },
    2: {
        ...
        'topics': [
            ...
            ('m2_2a', 'm2_2a_fastr_direct_import.md'),
            ('m2_2b', 'm2_2b_data_downloader.md'),
            ('m2_2c', 'm2_2c_data_downloader_login.md'),
            ('m2_2d', 'm2_2d_data_downloader_overview.md'),
            ('m2_2e', 'm2_2e_data_downloader_history.md'),
            ('m2_2f', 'm2_2f_data_downloader_dictionary.md'),
            ('m2_2g', 'm2_2g_data_downloader_facility_list.md'),
            ('m2_2h', 'm2_2h_data_downloader_facility_map.md'),
        ],
    },
    3: {
    ...
    6: {
        ...
        'topics': [
            ('m6_1', 'm6_1_service_utilization_analysis.md'),
            ('m6_1a', 'm6_1a_service_utilization_comparison_dhis2.md'),
            ('m6_2', 'm6_2_service_disruptions_surpluses_detection.md'),
            ('m6_5a', 'm6_5a_service_utilization_configuration_parameters.md'),
            ('m6_6', 'm6_6_service_coverage_introduction.md'),
            ('m6_7', 'm6_7_definition_of_coverage.md'),
            ('m6_8', 'm6_8_denominators_by_service_type.md'),
            ('m6_9', 'm6_9_demographic_cascade.md'),
            ('m6_10', 'm6_10_denominator_cascade_illustration.md'),
            ('m6_11', 'm6_11_deriving_denominators_from_entry_points.md'),
            ('m6_13', 'm6_13_denominator_selection_methodology.md'),
            ('m6_13a', 'm6_13a_denominator_comparison.md'),
            ('m6_14', 'm6_14_coverage_projection_methodology.md'),
            ('m6_19', 'm6_19_coverage_configuration_parameters.md'),
        ],
    },
    7: {
        ...
        'topics': [
            ...
            ('m7_1a', 'm7_1a_analytical_thinking_interpretation_continued.md'),
            ('m7_1b', 'm7_1b_analytical_thinking_interpretation_continued.md'),
            ('m7_1c', 'm7_1c_analytical_thinking_interpretation_continued.md'),
            ...
            ('m7_1i2', 'm7_1i2_combined_adjustment_output.md'),
            ('m7_1j', 'm7_1j_service_utilization_output.md'),
            ('m7_1k', 'm7_1k_year_over_year_change_output.md'),
            ('m7_1l', 'm7_1l_disruption_output_national.md'),
            ('m7_1m', 'm7_1m_disruption_output_subnational.md'),
            ('m7_1n', 'm7_1n_coverage_output_national.md'),
            ('m7_1o', 'm7_1o_coverage_output_subnational.md'),
            ('m7_2', 'm7_2_data_visualization_communication.md'),
            ('m7_2a', 'm7_2a_data_visualization_communication_continued.md'),
            ('m7_2b', 'm7_2b_data_visualization_communication_continued.md'),
            ('m7_2c', 'm7_2c_data_visualization_communication_continued.md'),
            ('m7_2d', 'm7_2d_data_visualization_communication_continued.md'),
            ('m7_3', 'm7_3_using_data_for_decision_making.md'),
            ('m7_3a', 'm7_3a_using_data_for_decision_making_continued.md'),
        ],
    },
    8: {
        'name': 'Survey & HFA',
    ...
    9: {
        ...
        'topics': [
            ...
            ('m9_2', 'm9_2_presenting_reports_group_feedback.md'),
        ],
    },
}
