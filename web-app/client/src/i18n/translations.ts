...
export const translations = {
  en: {
    ...
    autoGenerated: 'Auto',
    dragToReorder: 'Drag to reorder, or use ⌘↑ / ⌘↓ to move up/down. Drop on another day to move.',
    ...
    quickTextSlideTitle: 'Slide title',
    quickTextSlideBullets: 'One bullet per line',
    quickTextSlideSave: 'Add to day',
    quickTextSlideAdvanced: 'Open advanced editor',
    quickTextSlideHint: 'Fastest way to add a title + bullets. Press ⌘↵ to save.',
    ...
    editedForWorkshop: 'Edited for this workshop',
    addImage: 'Add image',
    replaceImage: 'Replace',
    removeImage: 'Remove',
    imagesOnSlide: 'Images on this slide',
    resetToLibrary: 'Reset to library version',
    resetToLibraryConfirm: "Discard this workshop's edits and go back to the library version of this slide?",
    multiSlideFile: 'This source file contains several slides — they are edited together.',
    staleForkBanner: 'The library version of this slide has changed since you edited it. Reset to the library version to pick up the update.',
    slideStyle: 'Slide style',
    slideStyleHint: 'The visual look applied to every slide — titles, covers, section dividers, and breaks — across preview, PDF, PowerPoint, and HTML.',
    checkDeck: 'Check deck',
    preflightTitle: 'Deck check',
    preflightAllClear: 'No issues found. The deck is ready to export.',
    preflightErrorsLabel: 'Problems',
    preflightWarningsLabel: 'Worth checking',
    exportAnyway: 'Export anyway',
    pfPlaceholder: 'Slide still says PLACEHOLDER',
    pfUnfilledVar: 'Template token {x} was not filled in',
    pfUnfilledObjectives: 'Objectives are not filled in',
    pfMissingImage: 'Image not found: {x}',
    pfOverflowSplit: 'Slide likely overflows — consider splitting ({x})',
    pfOverflowFlag: 'Slide may need manual layout attention ({x})',
    pfStaleFork: 'Edited slide is behind the library version ({x})',
  ...
  fr: {
    ...
    autoGenerated: 'Auto',
    dragToReorder: 'Glissez pour réorganiser, ou utilisez ⌘↑ / ⌘↓ pour monter/descendre. Déposez sur un autre jour pour déplacer.',
    ...
    quickTextSlideTitle: 'Titre de la diapositive',
    quickTextSlideBullets: 'Une puce par ligne',
    quickTextSlideSave: 'Ajouter au jour',
    quickTextSlideAdvanced: 'Ouvrir l\'éditeur avancé',
    quickTextSlideHint: 'Le plus rapide pour ajouter un titre + des puces. ⌘↵ pour enregistrer.',
    ...
    editedForWorkshop: 'Modifiée pour cet atelier',
    addImage: 'Ajouter une image',
    replaceImage: 'Remplacer',
    removeImage: 'Retirer',
    imagesOnSlide: 'Images de cette diapositive',
    resetToLibrary: 'Rétablir la version de la bibliothèque',
    resetToLibraryConfirm: 'Abandonner les modifications de cet atelier et revenir à la version de la bibliothèque pour cette diapositive ?',
    multiSlideFile: 'Ce fichier source contient plusieurs diapositives — elles se modifient ensemble.',
    staleForkBanner: 'La version de la bibliothèque de cette diapositive a changé depuis votre modification. Rétablissez la version de la bibliothèque pour récupérer la mise à jour.',
    slideStyle: 'Style des diapositives',
    slideStyleHint: 'L\'apparence appliquée à toutes les diapositives — titres, couvertures, séparateurs de section et pauses — dans l\'aperçu, le PDF, PowerPoint et le HTML.',
    checkDeck: 'Vérifier le deck',
    preflightTitle: 'Vérification du deck',
    preflightAllClear: 'Aucun problème détecté. Le deck est prêt à exporter.',
    preflightErrorsLabel: 'Problèmes',
    preflightWarningsLabel: 'À vérifier',
    exportAnyway: 'Exporter quand même',
    pfPlaceholder: 'La diapositive affiche encore PLACEHOLDER',
    pfUnfilledVar: 'Le champ {x} n\'a pas été renseigné',
    pfUnfilledObjectives: 'Les objectifs ne sont pas renseignés',
    pfMissingImage: 'Image introuvable : {x}',
    pfOverflowSplit: 'La diapositive déborde probablement — envisagez de la scinder ({x})',
    pfOverflowFlag: 'La diapositive nécessite peut-être un ajustement manuel ({x})',
    pfStaleFork: 'La diapositive modifiée est en retard sur la version de la bibliothèque ({x})',
