...
export const translations = {
  en: {
    ...
    tourLandingCardsTitle: 'Welcome to FASTR Deck Builder',
    tourLandingCardsDesc: 'Choose how to work: build a full workshop deck, quickly export selected slides, or browse the content library.',
    ...
    tourAddSessionDesc: 'Click here to add a module, break, or custom slide to this day.',
  ...
  fr: {
    ...
    tourLandingCardsTitle: 'Bienvenue dans FASTR Deck Builder',
    tourLandingCardsDesc: 'Choisissez votre mode : créer un diaporama complet, exporter rapidement des diapositives, ou parcourir la bibliothèque de contenu.',
    ...
    tourAddSessionDesc: 'Cliquez ici pour ajouter un module, une pause ou une diapositive personnalisée à cette journée.',
